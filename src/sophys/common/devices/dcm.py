...
class Energy(PVPositionerIsClose):
    ...
    readback = Component(EpicsSignalRO, "GonRx_Energy_RBV")
    actuate = Component(EpicsSignal, "EnergyUpdate_SP")
    atol = 1e-3
...
class GoniometerGantry(PVPositionerIsClose):
    ...
    setpoint = Component(EpicsSignalWithRBV, "GonRx_GantrySP", kind="hinted")
    readback = Component(EpicsSignal, "GonRx_S_RBV", kind="hinted")
    atol = 8e-5
