...
class Photomultiplier(Device):
    ...
    current_driver_porc = Component(
        EpicsSignalWithGetSet, "", ssuffix="CurrentDriverPorc"
    )

    sample_holder_speed = Component(
        EpicsSignalWithGetSet, "", ssuffix="SampleHolderSpeed"
    )
    sample_holder_type = Component(
        EpicsSignalWithGetSet, "", ssuffix="SampleHolderType"
    )
    ...
    digital_output_ch1 = Component(
        EpicsSignalWithGetSet, "", ssuffix="DigitalOutputCh1"
    )
    digital_output_ch2 = Component(
        EpicsSignalWithGetSet, "", ssuffix="DigitalOutputCh2"
    )
